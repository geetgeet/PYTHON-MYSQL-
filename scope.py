...
db_connection = mysql.connector.connect(user='lifechoices',password='@Lifechoices1234',
                             host='127.0.0.1',
                             auth_plugin='mysql_native_password')# creating database_cursor to perform SQL operation
...
class RegisterWindow(tk.Toplevel):
    ...
    def register(self):
        if db_connection.is_connected() == False:
            ...
            db_cursor.execute("CREATE DATABASE IF NOT EXISTS Userscope")# Create a Database Named AradhanaBank
        ...
        try: #implement sql Sentence
            ...
            mb.showinfo('Information', "Data insertion failed!!!")# Rollback in
...
class LoginApp(tk.Tk):
    ...
    def show(self):
        ...
        self.deiconify()
    def login(self):
        if db_connection.is_connected() == False: db_connection.connect()# executing cursor with execute method and pass SQL query
